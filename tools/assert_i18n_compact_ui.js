...
const checks = [
  ...
  ['no locale exposes unreplaced brand placeholders', locales.every((locale) => !/__WVB_/.test(JSON.stringify(catalogs[locale])) && catalogs[locale].appName?.message === 'LoudEase')],
