...
const switchReportPath = path.join(tmpDir, `latest-stability-switch-${scenarioSlug}.json`);
const latestSwitchReportPath = path.join(tmpDir, 'latest-stability-switch.json');
