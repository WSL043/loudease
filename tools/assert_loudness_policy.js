...
const checks = [
  ...
  ['player-volume compensation does not double-count peak headroom', /const liftRmsDb = liftWindowRmsDb \+ volumeCompensationDb;/.test(offscreen) && /liftPeakDb,\n\s+settings: this\.settings/.test(offscreen) && !/adjustedLiftPeakDb/.test(offscreen)],
