...
const syntaxTargets = [
  ...
  'tools/true_peak_candidate.js',
  'tools/true_peak_candidate_evaluation.js',
  'tools/true_peak_control_audit.js',
  'tools/candidate_quality_metrics.js',
  'tools/volume_intent_tests.js',
...
const scriptTargets = [
  ...
  ['tools/true_peak_candidate_evaluation.js', '--self-test'],
  ['tools/candidate_quality_metrics.js', '--self-test'],
  'tools/true_peak_control_audit.js',
  'tools/volume_intent_tests.js',
  'tools/volume_edge_tests.js',
  'tools/meter_worklet_tests.js',
