...
const checks = [
  ...
  ['contribution and license policies exist', /DSP changes and regressions/.test(contributing) && /MIT License/.test(license)],
  ...
  ['feedback remains user initiated without embedded service credentials', /GitHub is a manual feedback tracker/.test(feedback) && /must never contain a GitHub access token/.test(feedback) && /issues\/new\/choose/.test(monitor)],
