...
- Within a loud programme, positive moment-to-moment detail correction is capped at `6 dB` and fades out below the quiet-content floor. This prevents near-silence from becoming a second full-volume programme, but it also means LoudEase will not make every whisper or ambience bed exactly as loud as foreground content.
