...
2. The enabled Chrome Web Store Support Hub for questions, bug reports, and feature requests.
3. Public GitHub Issue Forms for reproducible engineering reports from testers and contributors.
